...
filterButton.on('click', function () {
    ...
    var inputCity = d3.select('#select-city').property('value')
    var inputState = d3.select('#select-state').property('value')
    var inputCountry = d3.select('#select-country').property('value')
    var inputShape = d3.select('#select-shape').property('value')
